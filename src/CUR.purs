...
newDeleteReportDefinitionRequest' :: ( { "ReportName" :: NullOrUndefined.NullOrUndefined (ReportName) } -> {"ReportName" :: NullOrUndefined.NullOrUndefined (ReportName) } ) -> DeleteReportDefinitionRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDeleteReportDefinitionResponse' :: ( { "ResponseMessage" :: NullOrUndefined.NullOrUndefined (DeleteResponseMessage) } -> {"ResponseMessage" :: NullOrUndefined.NullOrUndefined (DeleteResponseMessage) } ) -> DeleteReportDefinitionResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDescribeReportDefinitionsRequest' :: ( { "MaxResults" :: NullOrUndefined.NullOrUndefined (MaxResults) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"MaxResults" :: NullOrUndefined.NullOrUndefined (MaxResults) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> DescribeReportDefinitionsRequest
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDescribeReportDefinitionsResponse' :: ( { "ReportDefinitions" :: NullOrUndefined.NullOrUndefined (ReportDefinitionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } -> {"ReportDefinitions" :: NullOrUndefined.NullOrUndefined (ReportDefinitionList) , "NextToken" :: NullOrUndefined.NullOrUndefined (GenericString) } ) -> DescribeReportDefinitionsResponse
...
--   This may be useful if you need to immediately overwrite some of the optional values
newDuplicateReportNameException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (ErrorMessage) } -> {"Message" :: NullOrUndefined.NullOrUndefined (ErrorMessage) } ) -> DuplicateReportNameException
...
--   This may be useful if you need to immediately overwrite some of the optional values
newReportDefinition' :: SchemaElementList -> CompressionFormat -> ReportFormat -> ReportName -> S3Bucket -> S3Prefix -> AWSRegion -> TimeUnit -> ( { "ReportName" :: (ReportName) , "TimeUnit" :: (TimeUnit) , "Format" :: (ReportFormat) , "Compression" :: (CompressionFormat) , "AdditionalSchemaElements" :: (SchemaElementList) , "S3Bucket" :: (S3Bucket) , "S3Prefix" :: (S3Prefix) , "S3Region" :: (AWSRegion) , "AdditionalArtifacts" :: NullOrUndefined.NullOrUndefined (AdditionalArtifactList) } -> {"ReportName" :: (ReportName) , "TimeUnit" :: (TimeUnit) , "Format" :: (ReportFormat) , "Compression" :: (CompressionFormat) , "AdditionalSchemaElements" :: (SchemaElementList) , "S3Bucket" :: (S3Bucket) , "S3Prefix" :: (S3Prefix) , "S3Region" :: (AWSRegion) , "AdditionalArtifacts" :: NullOrUndefined.NullOrUndefined (AdditionalArtifactList) } ) -> ReportDefinition
...
--   This may be useful if you need to immediately overwrite some of the optional values
newReportLimitReachedException' :: ( { "Message" :: NullOrUndefined.NullOrUndefined (ErrorMessage) } -> {"Message" :: NullOrUndefined.NullOrUndefined (ErrorMessage) } ) -> ReportLimitReachedException
